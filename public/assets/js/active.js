...
if (scrollButton) {
    window.addEventListener('scroll', () => {
        if (document.body.scrollTop > topDistance || document.documentElement.scrollTop > topDistance) {
            ...
            if (whatsappButton) {
                whatsappButton.classList.add('scrolltop-show');
                whatsappButton.classList.remove('scrolltop-hide');
            }
        } else {
            scrollButton.classList.add('scrolltop-hide');
            scrollButton.classList.remove('scrolltop-show');
            if (whatsappButton) {
                whatsappButton.classList.add('scrolltop-hide');
                whatsappButton.classList.remove('scrolltop-show');
            }
        }
    });
