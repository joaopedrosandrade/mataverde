             ...
             <div class="about-content ps-md-5">
                ...
                <div class="d-flex flex-column gap-4 mb-5">
                   ...
                   <div class="about-card-sm d-flex align-items-center gap-3">
                      ...
                      <div>
                         <h4>Eucalipto Tratado</h4>
                         <p class="mb-0">Madeira de eucalipto tratada em autoclave para máxima durabilidade e resistência.</p>
                      </div>
                   </div>
                   ...
                   <div class="about-card-sm d-flex align-items-center gap-3">
                      ...
                      <div>
                         <h4>Processo Autoclavado</h4>
                         <p class="mb-0">Tecnologia avançada de tratamento em autoclave para máxima proteção.</p>
                      </div>
                   </div>
                </div>
