...
/* Estilos para os passos do processo produtivo */
.process-step {
    padding: 1rem;
    border-radius: 8px;
             ...
             <div class="hero-content home-one">
                ...
                <div class="hero-cta wow fadeInUp" data-wow-delay="900ms" data-wow-duration="1000ms">
                   <div class="cta-content">
                      ...
                      <!--<div class="cta-features mt-5 d-flex flex-wrap gap-4">
                         <div class="feature-item d-flex align-items-center gap-2">
                            <i class="ti ti-check-circle text-success"></i>
                            <span class="text-white">Garantia de 15-25 anos</span>
                         </div>
                         <div class="feature-item d-flex align-items-center gap-2">
                            <i class="ti ti-check-circle text-success"></i>
                            <span class="text-white">Entrega em todo Brasil</span>
                         </div>
                         <div class="feature-item d-flex align-items-center gap-2">
                            <i class="ti ti-check-circle text-success"></i>
                            <span class="text-white">Certificações de qualidade</span>
                         </div>
                      </div>-->
                   </div>
                </div>
           ...
           <div class="col-12 col-lg-6 order-1 order-lg-2">
              <div class="about-content ps-md-5">
                 <div class="section-heading">
                    ...
                    <h2 class="mb-4">Empresa Líder em Eucalipto Tratado</h2>
                 </div>

                 <div class="mb-4">
                    <h4 class="mb-3">Controle de todo processo produtivo:</h4>
                 </div>
                 ...
                 <div class="d-flex flex-column gap-4 mb-5">
                    ...
                    <div class="process-step d-flex align-items-center gap-3">
                       ...
                       <div class="process-content">
                          ...
                          <p class="mb-0 text-muted">Seleção criteriosa das melhores espécies de eucalipto para garantir qualidade superior.</p>
                       </div>
                    </div>
                    ...
                    <div class="process-step d-flex align-items-center gap-3">
                       ...
                       <div class="process-content">
                          ...
                          <p class="mb-0 text-muted">Manejo sustentável e técnicas avançadas para o desenvolvimento das florestas.</p>
                       </div>
                    </div>
                    ...
                    <div class="process-step d-flex align-items-center gap-3">
                       ...
                       <div class="process-content">
                          ...
                          <p class="mb-0 text-muted">Operação eficiente e cuidadosa do corte até o transporte para nossa usina.</p>
                       </div>
                    </div>
                    ...
                    <div class="process-step d-flex align-items-center gap-3">
                       ...
                       <div class="process-content">
                          ...
                          <p class="mb-0 text-muted">Processo de tratamento em autoclave e expedição para todo o Brasil.</p>
                       </div>
                    </div>
                 </div>
       ...
       <div class="row g-5 align-items-center">
          ...
          <div class="col-12 col-lg-6">
             <div class="why-choose-content ps-xxl-5">
                <div class="section-heading">
                   <span class="sub-title text-success">Várias formas de aplicações</span>
                   <h2 class="mb-4">Qualidade e Confiança em Madeiras Tratadas</h2>
                   <p class="mb-5">A Madeiras Mata Verde é referência em qualidade e durabilidade. Nossos produtos são tratados com tecnologia avançada para garantir máxima proteção e vida útil prolongada.
                   </p>
                </div>
                ...
                <div class="d-flex flex-column gap-4 mb-5">
                   ...
                   <div class="about-card-sm d-flex align-items-center gap-2 gap-sm-3">
                      ...
                      <h4 class="mb-0">Qualidade Garantida</h4>
                      <div class="line"></div>
                      <p class="mb-0">Produtos certificados com garantia de durabilidade.</p>
                   </div>
                   ...
                   <div class="about-card-sm d-flex align-items-center gap-2 gap-sm-3">
                      ...
                      <h4 class="mb-0">Meio Ambiente</h4>
                      <div class="line"></div>
    ...
    <div class="container">
       <div class="row g-5 align-items-end">
          <div class="col-12 col-sm-6">
             <!-- Section Heading -->
             <div class="section-heading">
                <span class="sub-title text-success">Depoimentos</span>
                <h2 class="mb-0">O Que Nossos Clientes Dizem</h2>
             </div>
          </div>
                         ...
                         <div class="form-group">
                            <label for="telefone">
                               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                  fill="none">
                                  <path
                                     d="M6.62 10.79C8.06 13.62 10.38 15.93 13.21 17.38L15.41 15.18C15.68 14.91 16.08 14.82 16.43 14.94C17.55 15.31 18.76 15.51 20 15.51C20.55 15.51 21 15.96 21 16.51V20C21 20.55 20.55 21 20 21C10.61 21 3 13.39 3 4C3 3.45 3.45 3 4 3H7.5C8.05 3 8.5 3.45 8.5 4C8.5 5.25 8.7 6.45 9.07 7.57C9.18 7.92 9.1 8.31 8.82 8.59L6.62 10.79ZM9.07 7.57C9.18 7.92 9.1 8.31 8.82 8.59L6.62 10.79C8.06 13.62 10.38 15.93 13.21 17.38L15.41 15.18C15.68 14.91 16.08 14.82 16.43 14.94C17.55 15.31 18.76 15.51 20 15.51C20.55 15.51 21 15.96 21 16.51V20C21 20.55 20.55 21 20 21C10.61 21 3 13.39 3 4C3 3.45 3.45 3 4 3H7.5C8.05 3 8.5 3.45 8.5 4C8.5 5.25 8.7 6.45 9.07 7.57Z"
                                     fill="#767676" />
                               </svg>
                            </label>
                            <input type="text" id="telefone" class="form-control bg-secondary" name="telefone"
                               placeholder="Telefone *">
                         </div>
                      </div>
                      <div class="col-12">
                         <select name="subject" id="subject" class="touria-select2 bg-secondary">
                            <option value="" selected>Selecionar Assunto</option>
                            <option value="orcamento">Solicitar Orçamento</option>
                            <option value="representante">Seja um Representante</option>
                            <option value="produtos">Informações sobre Produtos</option>
                            <option value="qualidade">Certificações de Qualidade</option>
                         </select>
                      </div>
                      <div class="col-12">
                         <div class="form-group">
 ...
 <section class="blog-section">
    ...
    <div class="container">
       <div class="row g-5 align-items-end">
          ...
          <div class="col-12 col-sm-6">
             <div class="section-heading">
                <span class="sub-title text-success">Notícias & Atualizações</span>
                <h2 class="mb-0">Últimas Notícias e Artigos</h2>
             </div>
          </div>
             ...
             <div class="blog-card style-two wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
                ...
                <div class="post-body">
                   <div class="blog-meta d-flex flex-wrap align-items-center gap-2">
                      <a href="#">Por Mata Verde</a>
                      <div class="dot"></div>
                      <a href="#">26 Junho 2025</a>
                   </div>
