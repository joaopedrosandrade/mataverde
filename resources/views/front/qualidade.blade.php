            ...
            <div class="processo-autoclave">
               ...
               <div class="processo-etapa">
                  ...
                  <div class="etapa-conteudo">
                     <div class="etapa-imagem">
                        <div class="autoclave">
                           <div class="autoclave-base"></div>
                           <div class="madeira-inset">
                              <div class="madeira-section"></div>
                              <div class="seta-movimento seta-direita"></div>
                           </div>
                        </div>
                     </div>
                     <div class="etapa-texto">
                        <h5>A MADEIRA PREPARADA PARA O TRATAMENTO É INTRODUZIDA NA AUTOCLAVE</h5>
                        <p>A madeira é cuidadosamente preparada e posicionada dentro do autoclave para iniciar o processo de tratamento.</p>
                     </div>
                  </div>
               </div>

               <!-- Seta de conexão -->
               <div class="seta-conexao seta-horizontal"></div>
                  ...
                  <div class="etapa-conteudo">
                     <div class="etapa-imagem">
                        <div class="autoclave">
                           ...
                           <div class="madeira-inset">
                              <div class="madeira-section"></div>
                              <div class="setas-ar setas-saindo">
                                 <div class="seta-ar"></div>
                                 <div class="seta-ar"></div>
                                 <div class="seta-ar"></div>
                                 <div class="seta-ar"></div>
                              </div>
                     ...
                     <div class="etapa-texto">
                        <h5>O VÁCUO INICIAL RETIRA O AR EXISTENTE NO INTERIOR DAS CÉLULAS DA MADEIRA</h5>
                        <p>O vácuo remove todo o ar presente nas células da madeira, preparando-a para receber a solução preservativa.</p>
                     </div>
                  </div>
               </div>
               ...
               <div class="processo-etapa">
                  ...
                  <div class="etapa-conteudo">
                     <div class="etapa-imagem">
                        <div class="autoclave">
                           <div class="autoclave-base solucao-baixa"></div>
                           <div class="madeira-inset">
                              <div class="madeira-section"></div>
                              <div class="seta-solucao seta-direita"></div>
                           </div>
                        </div>
                     </div>
                     <div class="etapa-texto">
                        <h5>SOB VÁCUO A SOLUÇÃO DE TRATAMENTO É TRANSFERIDA PARA A AUTOCLAVE</h5>
                        <p>A solução preservativa CCA é introduzida no autoclave, preenchendo o espaço ao redor da madeira.</p>
                     </div>
                  </div>
               </div>

               <!-- Seta de conexão -->
               <div class="seta-conexao seta-vertical"></div>
               ...
               <div class="processo-etapa">
                  ...
                  <div class="etapa-conteudo">
                     <div class="etapa-imagem">
                        <div class="autoclave">
                           <div class="autoclave-base solucao-alta"></div>
                           <div class="madeira-inset">
                              <div class="madeira-section"></div>
                              <div class="setas-pressao setas-entrando">
                                 <div class="seta-pressao"></div>
                                 <div class="seta-pressao"></div>
                                 <div class="seta-pressao"></div>
                                 <div class="seta-pressao"></div>
                              </div>
                     ...
                     <div class="etapa-texto">
                        <h5>SOB ALTA PRESSÃO A SOLUÇÃO DE TRATAMENTO É INJETADA NA MADEIRA ATÉ SATURAÇÃO</h5>
                        <p>A alta pressão força a penetração da solução preservativa profundamente na madeira, garantindo proteção completa.</p>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="etapa-conteudo">
                     <div class="etapa-imagem">
                        <div class="autoclave">
                           ...
                           <div class="madeira-inset">
                              <div class="madeira-section"></div>
                              <div class="seta-excesso seta-esquerda"></div>
                           </div>
                        </div>
                     </div>
                     <div class="etapa-texto">
                        <h5>A PRESSÃO É ALIVIADA E A SOLUÇÃO EXCEDENTE RETORNA AO RESERVATÓRIO</h5>
                        <p>A pressão é reduzida gradualmente, permitindo que a solução excedente retorne ao reservatório de tratamento.</p>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="etapa-conteudo">
                     <div class="etapa-imagem">
                        <div class="autoclave">
                           ...
                           <div class="madeira-inset">
                              <div class="madeira-section"></div>
                              <div class="setas-final setas-saindo">
                                 <div class="seta-final"></div>
                                 <div class="seta-final"></div>
                                 <div class="seta-final"></div>
                                 <div class="seta-final"></div>
                              </div>
                     ...
                     <div class="etapa-texto">
                        <h5>O VÁCUO FINAL RETIRA O EXCESSO DA SOLUÇÃO NA SUPERFÍCIE DA MADEIRA</h5>
                        <p>Um vácuo final remove qualquer solução residual da superfície da madeira, preparando-a para a secagem.</p>
                     </div>
                  </div>
               </div>
            </div>
